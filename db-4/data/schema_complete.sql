...
CREATE TABLE public.seydam_payment (
    id bigint NOT NULL,
    reports_paid integer NOT NULL,
    last_reference character varying(255),
...
CREATE TABLE public.seydam_reportjobid (
    ...
    report_id uuid,
    user_id bigint NOT NULL,
    CONSTRAINT seydam_reportjobid_progress_check CHECK ((progress >= 0))
);
CREATE TABLE public.seydam_reports (
    ...
    amounted_credits integer NOT NULL,
...
CREATE TABLE public.seydam_surveyresponse (
    ...
    recommend_score text NOT NULL,
    process_easy boolean NOT NULL,
    process_feedback text,
    met_expectations boolean NOT NULL,
    most_valuable_feature character varying(50) NOT NULL,
    submitted_at timestamp with time zone NOT NULL,
    user_id bigint NOT NULL,
    CONSTRAINT seydam_surveyresponse_satisfaction_score_check CHECK ((satisfaction_score >= 0))
);
