# Database 8 - Job Market Intelligence - Extremely Complex SQL Queries

# Database Schema: DB8

**Description:** Job Market Intelligence and Targeted Application System
**Created:** 2026-02-04

## Overview

This database contains job market intelligence data from .gov sources (USAJobs.gov, BLS, Department of Labor) and aggregated sources, supporting targeted job applications, market analytics, skill demand analysis, and AI-powered job recommendations mirroring jobright.ai functionality.
